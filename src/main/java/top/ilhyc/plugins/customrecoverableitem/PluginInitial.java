...
public class PluginInitial {
    public static CustomRecoverableItem plugin;
    public static File playerdata;

    public PluginInitial(CustomRecoverableItem plugin){
        this.plugin = plugin;
    }
    ...
    public static String log(String s){
        s = CustomRecoverableItem.Auto(s);
        Bukkit.getLogger().info(s);
        return s;
    }

    public static String warn(String s){
        s = CustomRecoverableItem.Auto("&f["+"&e"+plugin.getName()+"&f]"+s);
        Bukkit.getLogger().info(s);
        return s;
    }
